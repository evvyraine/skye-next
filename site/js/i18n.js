export const strings = {
  ru: {
    ...
    pricingTitle: "Три тарифа\nи пробный доступ",
    pricingNote: "Оплата в Telegram Stars",
    perMonth: "в месяц",
    trialPeriod: "один раз",
    trialName: "✨ Try Skye",
    trialPrice: "49 ⭐",
    trial1: "7 дней с Luna",
    trial2: "Один раз на аккаунт",
    trial3: "Без продления",
    trial4: "Fair Use",
    plusName: "🌙 Skye Plus",
    plusPrice: "499 ⭐",
    plus1: "Luna без ограничений",
    plus2: "Fair Use",
    plus3: "Продление каждые 30 дней",
    superName: "🌍 Skye Super",
    superPrice: "1 199 ⭐",
    super1: "Terra без ограничений",
    super2: "Включает Luna",
    super3: "Fair Use",
    super4: "Продление каждые 30 дней",
    ultraName: "☀️ Skye Ultra",
    ultraPrice: "2 599 ⭐",
    ultra1: "Sol без ограничений",
    ultra2: "Включает Luna и Terra",
    ultra3: "Fair Use",
    ultra4: "Продление каждые 30 дней",
  ...
  en: {
    ...
    pricingTitle: "Three plans\nand a trial",
    pricingNote: "Paid in Telegram Stars",
    perMonth: "per month",
    trialPeriod: "once",
    trialName: "✨ Try Skye",
    trialPrice: "49 ⭐",
    trial1: "7 days with Luna",
    trial2: "Once per account",
    trial3: "Does not renew",
    trial4: "Fair Use",
    plusName: "🌙 Skye Plus",
    plusPrice: "499 ⭐",
    plus1: "Unlimited Luna",
    plus2: "Fair Use",
    plus3: "Renews every 30 days",
    superName: "🌍 Skye Super",
    superPrice: "1 199 ⭐",
    super1: "Unlimited Terra",
    super2: "Includes Luna",
    super3: "Fair Use",
    super4: "Renews every 30 days",
    ultraName: "☀️ Skye Ultra",
    ultraPrice: "2 599 ⭐",
    ultra1: "Unlimited Sol",
    ultra2: "Includes Luna and Terra",
    ultra3: "Fair Use",
    ultra4: "Renews every 30 days",
